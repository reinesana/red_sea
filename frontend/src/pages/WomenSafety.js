function WomenSafety() {
  return (
    <div className="women-safety">
      ...
      <p>
        Don't hesitate to ask for help: If you feel unsafe or require
        assistance, reach out to shelter staff, local authorities, or other
        individuals nearby.
      </p>
      <p>
        Utilize community resources: Take advantage of community resources
        available at shelters, such as counseling services or support groups for
        women and families.
      </p>
      <p>
        Remember, your safety and well-being are paramount. Take proactive
